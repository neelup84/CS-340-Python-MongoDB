...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb  8 00:41:07 2022

@author: neelima.patna_snhu
"""
...
class AnimalShelter(object):
    ...
    def __init__(self, user, password):
            ...
            self.client = MongoClient('mongodb://%s:%s@localhost:37392/AAC' % (user, password))
